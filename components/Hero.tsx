...
import { TextGenerateEffect } from "./TextGenrateEffect";
   ...
   <>
    <div className="pb-20 pt-36">
        ...
        <div className="flex justify-center relative my-20 z-10 ">
            ...
            />
            <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">Hi, I&apos;am Sam a Next.js Developer based in Stockton, CA</p>
            <a href="#about"><ButtonComp position="right" title="My Projects" icon={<GoProjectRoadmap/>}/></a>
